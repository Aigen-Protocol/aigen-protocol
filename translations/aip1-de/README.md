# AIP-1 (Mission Lifecycle) — German translation

This directory contains the faithful **German (`de`)** translation of
...
- **`aip-1.de.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-1.de.md`.
...
Only **prose and headings** are translated to German. The following are
...
- `aip-1.fr.md` — French
- `aip-1.zh.md` — Chinese
- `aip-1.de.md` — German (this directory)
