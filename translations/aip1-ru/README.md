# AIP-1 (Mission Lifecycle) — Russian translation

This directory contains the faithful **Russian (`ru`)** translation of
...
- **`aip-1.ru.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-1.ru.md`.
...
Only **prose and headings** are translated to Russian. The following are
...
This is part of the AIP-1 translation set, all following the same policy and
...
- `aip-1.de.md` — German
- `aip-1.zh.md` — Chinese
- `aip-1.ja.md` — Japanese
- `aip-1.ko.md` — Korean
- `aip-1.pt.md` — Portuguese
- `aip-1.ar.md` — Arabic
- `aip-1.ru.md` — Russian (this directory)
