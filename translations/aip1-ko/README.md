# AIP-1 (Mission Lifecycle) — Korean translation

This directory contains the faithful **Korean (`ko`)** translation of
...
- **`aip-1.ko.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-1.ko.md`.
...
Only **prose and headings** are translated to Korean. The following are
