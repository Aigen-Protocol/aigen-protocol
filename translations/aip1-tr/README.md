# AIP-1 (Mission Lifecycle) — Turkish translation

This directory contains the faithful **Turkish (`tr`)** translation of
...
- **`aip-1.tr.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-1.tr.md`.

## What it covers

The full mission lifecycle, mirroring canonical AIP-1 section-for-section:

1. Scope & model (Kapsam ve model)
...
8. Translator's note (Çevirmen notu)
9. Appendix A — lifecycle cheat sheet

## Translation policy (normative)

Only **prose and headings** are translated to Turkish. The following are
