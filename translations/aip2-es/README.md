# AIP-2 (Verification & Oracles) — Spanish translation
...
- **`aip-2.es.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-2.es.md`.
...
translator's note, and the verification cheat sheet (Appendix A).
...
cp aip-2.es.md <your-project-dir>/i18n/aip-2.es.md
```
