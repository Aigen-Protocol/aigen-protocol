# AIP-3 (Discovery, A2A & MCP Transport) — Simplified Chinese translation
...
- **`aip-3.zh.md`** — the translation. Final install target:
  `<your-project-dir>/i18n/aip-3.zh.md`.
...
Headings are translated to Simplified Chinese; the in-page table-of-contents
anchors point to those Chinese headings, while every normative identifier inside
them is kept in English.
...
cp aip-3.zh.md <your-project-dir>/i18n/aip-3.zh.md
```
