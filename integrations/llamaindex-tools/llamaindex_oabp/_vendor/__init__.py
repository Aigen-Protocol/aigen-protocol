"""Vendored third-party packages bundled with ``llamaindex_oabp``.

This sub-package ships a pinned copy of the **OABP Python SDK** (the ``oabp``
package) so that the LlamaIndex integration is self-contained and importable
...
import path; see :mod:`llamaindex_oabp._sdk` for the resolution logic.
"""
